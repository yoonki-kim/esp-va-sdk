...
/** These APIs should be implemented to be used with an existing aws_iot mqtt connection. */
/** OTA Init
This API needs to be implemented by the application.
This API should use an existing aws_iot mqtt connection and publish/subscribe to OTA specific topics.
*/
void cloud_agent_init();

/** OTA Deinit
This API needs to be implemented by the application.
This API should unsubscribe from the update topic on the mqtt from the cloud.
*/
void cloud_agent_deinit();
